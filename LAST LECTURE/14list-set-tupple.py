...
print(fish[-5:])
print(fish[-5:-9])  # :+9
#due to incorrect slicing it give empty list
print(fish[3:10:2])

#it is method to convert list/ into tuple and vice versa
tmp = tuple(fish)
...
#tuple cannot be changed e.t.c (remove,append,extend,clear())
#fish.clear()
